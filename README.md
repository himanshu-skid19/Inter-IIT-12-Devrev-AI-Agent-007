...
COT prompting was used to enhance the reasoning capabilities of the LLM.
#### Hallucination Check
We detect all forseeable hallucinations that may occur
#### Corrective Reprompting
If hallucinations are detected, we ensure they are removed reprompting the LLM.
#### Memory
To effectively manage the conversational aspects of the query.
