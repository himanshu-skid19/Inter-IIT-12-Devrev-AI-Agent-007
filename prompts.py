...
Remember:To solve the current query and use for tools or arguments, you can extract any information from the past conversation provided.
EXAMPLES BEGIN
...
{chat_history}
From your solution in the previous conversation extract a list of JSONs where each json follows the following schema \
